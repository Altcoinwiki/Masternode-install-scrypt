...
# (c) 2018 by Cryptominer937 for Wiki Coin
#
...
cd ~
mkdir ~/Scripts/wiki
sudo rm wiki-Linux64-V1.2.1
wget https://github.com/wikiCoinX/wikiCoin/releases/download/2.0.1/wiki-mn-2.0.1-ubuntu.tar.gz
tar xzf wiki-mn-2.0.1-ubuntu.tar.gz -C ~/Scripts/wiki
rm -r wiki-mn-2.0.1-ubuntu.tar.gz
stop_daemon
